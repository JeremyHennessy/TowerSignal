...
export function WorkflowWorkspacePage({
  ...
  return <section className="product-page workflow-workspace-page">
    ...
    <details className="workflow-section-block workflow-future-block workflow-future-details">
      <summary><div><span className="page-kicker">Future evidence lanes</span><strong>Planned extensions</strong><p>Keep roadmap fields separate from live intelligence. Expand to see where future field-service, treatment, document and relationship data will land.</p></div><span>{futureLanes.length}</span></summary>
