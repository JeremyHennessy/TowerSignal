...
function NysChangeCard({ event }: { event: NysChangeEvent; current: NysSystem | null; onSelect: (row: NysSystem | null) => void }) {
  return <article className="change-card"><strong>{event.system_id}</strong></article>
}
