  ...
  return <>
    ...
    <div className={`table-card account-table-card prospect-table-preset-${preset}`} data-prospect-preset={preset}>
      ...
      {rows.length === 0 ? <div className="empty-state"><strong>No accounts match these filters.</strong><span>Try widening the territory, timing signal or priority criteria.</span></div> : <div className="table-scroll"><table className="account-table"><thead><tr>
        {preset === 'timing' && <><th scope="col"><button onClick={() => changeSort('address')}>Account</button></th><th scope="col"><button onClick={() => changeSort('priority_score')}>Priority</button></th><th scope="col">Timing signal</th><th scope="col">Contact</th><th scope="col"><button onClick={() => changeSort('days_since_latest_sample')}>Sampling</button></th><th scope="col"><button onClick={() => changeSort('oath_case_count')}>Activity</button></th><th scope="col">Evidence</th><th scope="col" aria-label="Open account" /></>}
        {preset === 'sales' && <><th scope="col"><button onClick={() => changeSort('address')}>Account</button></th><th scope="col"><button onClick={() => changeSort('priority_score')}>Priority</button></th><th scope="col">Contact / owner</th><th scope="col">Property scale</th><th scope="col">Observed firms</th><th scope="col">Project activity</th><th scope="col">Institutional</th><th scope="col">Evidence</th><th scope="col" aria-label="Open account" /></>}
        {preset === 'field' && <><th scope="col"><button onClick={() => changeSort('address')}>Account</button></th><th scope="col"><button onClick={() => changeSort('priority_score')}>Priority</button></th><th scope="col"><button onClick={() => changeSort('active_equipment')}>Equipment / roof</button></th><th scope="col"><button onClick={() => changeSort('days_since_latest_sample')}>Sampling</button></th><th scope="col"><button onClick={() => changeSort('latest_inspection_date')}>Inspection</button></th><th scope="col">Domestic water</th><th scope="col">Infrastructure</th><th scope="col">Enforcement</th><th scope="col">Evidence</th><th scope="col" aria-label="Open account" /></>}
