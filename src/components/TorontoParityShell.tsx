...
import type { TorontoMarketPayload, TorontoProperty, TorontoRelationship, TorontoSourceLink } from '../types/toronto'
...
function PropertyAction({ row, watched, onToggleWatch, onOpen }: { row: ProspectRow; watched: boolean; onToggleWatch: () => void; onOpen: () => void }) {
