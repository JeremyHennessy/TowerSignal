...
from towersignal.domestic_water import build_payload  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build TowerSignal domestic-water/provider intelligence cache")
