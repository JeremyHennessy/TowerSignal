        ...
        relevant_contracts.append(
            {
                ...
                "source_contract_id": transactions[0]["contract_number"],
                ...
                "company_resolution_method": "NO_SAFE_MATCH",
                "buyer_name": transactions[0]["department_facility"],
                "agency": "Open Book NY",
                "department_facility": transactions[0]["department_facility"],
                "title": descriptions[0] if descriptions else transactions[0]["contract_number"],
                ...
                "observed_value_evidence": (
                    "Net/source transaction amounts from Open Book contract and amendment history; "
                    "not company revenue and not labeled as spending-to-date."
                ),
                "start_date": start_date,
                "end_date": end_date,
                "award_date": approved[-1] if approved else None,
                "latest_approved_filed_date": approved[-1] if approved else None,
                "source_date_status": _contract_status(
                    start_date, end_date, as_of
                ),
                "status": _contract_status(start_date, end_date, as_of),
                "facility_match_confidence": "UNLINKED",
                "tower_link_confidence": "UNLINKED",
                "tower_account_system_ids": [],
                "source_dataset_id": "NYS_OPEN_BOOK_CSV_EXPORT",
