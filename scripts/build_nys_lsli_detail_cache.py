...
def build(output: Path, *, request_delay_seconds: float) -> dict:
    payload = build_payload(request_delay_seconds=request_delay_seconds)
...
def main() -> None:
    ...
    payload = build(args.output, request_delay_seconds=args.request_delay_seconds)
