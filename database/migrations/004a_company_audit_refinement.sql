...
BEGIN
  ...
  LOOP
    ...
    IF TG_OP = 'INSERT' AND (new_value IS NULL OR new_value = 'null'::jsonb) THEN CONTINUE; END IF;
    IF TG_OP = 'DELETE' AND (old_value IS NULL OR old_value = 'null'::jsonb) THEN CONTINUE; END IF;
