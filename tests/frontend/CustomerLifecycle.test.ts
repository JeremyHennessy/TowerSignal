...
test('client and types expose subscription and renewal CRUD',()=>{
  ...
  expect(client).toContain('loadAllCompanySalesSubscriptions')
  expect(client).toContain('addCompanySalesSubscription')
  expect(client).toContain('saveCompanySalesSubscription')
  expect(client).toContain('loadAllCompanySalesRenewals')
...
test('company CRM exposes customer lifecycle and renewal attention',()=>{
  ...
  expect(commandCenter).toContain('loadAllCompanySalesSubscriptions')
  expect(commandCenter).toContain('loadAllCompanySalesRenewals')
