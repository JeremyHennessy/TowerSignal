...
PERMIT_SOURCES = {
    "toronto_building_permits_active_targeted": ("toronto_building_permits_active_targeted.json", 573, 572),
    "toronto_building_permits_cleared_targeted_since_2017": ("toronto_building_permits_cleared_targeted_since_2017.json", 721, 719),
}
...
class TorontoBuildingPermitApplyTests(unittest.TestCase):
    def test_persisted_permit_apply_contract(self) -> None:
        ...
        self.assertEqual(len(permit_links), 1291)
