...
The final-spine aerial rerun used 46 reconciled confirmed training properties, 92 weak controls, and 138 usable images with no fetch failures. It scored 1,200 candidates and saved 50 artifact-only review crops. Weak-label ROC-AUC was 0.5099 and balanced accuracy at 0.5 was 0.5326. These results show no reliable real-world tower discrimination; the application exposes only a review queue and never treats these scores as tower evidence.
